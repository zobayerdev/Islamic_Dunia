...
class IslamicStoryScreen extends StatefulWidget {
  const IslamicStoryScreen({super.key});

  @override
  State<IslamicStoryScreen> createState() => _IslamicStoryScreenState();
}

class _IslamicStoryScreenState extends State<IslamicStoryScreen> {
  @override
  void initState() {
    super.initState();
    getStoryRX.storyAPI();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: 'ইসলামিক গল্প ও কাহিনীসমূহ',
      ),
      body: Container(
                          ...
                          return GestureDetector(
                            onTap: () {
                              NavigationService.navigateToWithArgs(
                                Routes.islamicStoryViewScreen,
                                {
                                  'title': stories[index].title,
                                  'reference': stories[index].reference,
